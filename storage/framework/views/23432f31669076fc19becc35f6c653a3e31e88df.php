    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a class="load" href="" data-href="<?php echo e(url('home')); ?>" data-content=".box-content" data-img-load="#img-load"><img src="images/logo.png" /></a>
                            </div>
                        </div>
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li><a class="load" href="" data-href="<?php echo e(url('home')); ?>" data-content=".box-content" data-img-load="#img-load">Inicio</a></li>
                                    ...
                                    <li class="dropdown"><a class="load" href="" data-href="<?php echo e(url('blog')); ?>" data-content=".box-content" data-img-load="#img-load">Blog</a></li> 
                                    <li><a class="load" href="" data-href="<?php echo e(url('moda-do-momento')); ?>" data-content=".box-content" data-img-load="#img-load">Moda do Momento</a></li>
                                    <li><a class="load" href="" data-href="<?php echo e(url('contatos')); ?>" data-content=".box-content" data-img-load="#img-load">Contatos</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-3">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" id="menu">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li class="active"><a class="load" href="" data-href="<?php echo e(url('home')); ?>" data-content=".box-content" data-img-load="#img-load">Inicio <span class="sr-only">(current)</span></a></li>
                    <li class="dropdown">
                    ...
                    <li><a class="load" href="" data-href="<?php echo e(url('blog')); ?>" data-content=".box-content" data-img-load="#img-load">Blog</a></li>
                    <li><a class="load" href="" data-href="<?php echo e(url('moda-do-momento')); ?>" data-content=".box-content" data-img-load="#img-load">Moda do Momento</a></li>
                    <li><a class="load" href="" data-href="<?php echo e(url('contatos')); ?>" data-content=".box-content" data-img-load="#img-load">Contatos</a></li>
                </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 padding-right">
                            <div class="features_items"><!--Itens de Recurso-->
					            ...
					            <div class="load-go" data-href="<?php echo e(url('list-products')); ?>" data-img-load="#img-load-products"></div>
